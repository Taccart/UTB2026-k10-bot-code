...
public:
    ...
    /**
     * @fn asUDPMessageHandlerInterface
     * @brief Check if this service implements IsUDPMessageHandlerInterface
     * @return Pointer to IsUDPMessageHandlerInterface if implemented, nullptr otherwise
     */
    virtual IsUDPMessageHandlerInterface *asUDPMessageHandlerInterface() { return nullptr; }
    /**
